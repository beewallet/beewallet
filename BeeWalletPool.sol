...
import {BWTToken} from "./BWTToken.sol";
 ...
 * @title Pool contract
 *
 * @notice Main point of interaction with an BeeWallet protocol's market
 * - Users can:
 *   # Supply
 *   # Withdraw
 *   # Borrow
 ...
 **/
contract BeeWalletPool is BWTToken, IPool {
    ...
    function _safeTransferFrom(
        ...
        require(
            success && (data.length == 0 || abi.decode(data, (bool))),
            "BeeWalletPool: TRANSFER_FROM_FAILED"
        );
    }
